...
const PostButton = styled.button`
	...
	padding: 0 16px;
	border-radius: 20px;
	background: ${(props) => (props.disabled ? "#0a66c2" : "#b8b8b8" )};
	color: ${(props) => (props.disabled ? "#fff" : "#5a5a5a")};
	font-size: 16px;
            ...
            <Content>
                ...
                <SharedContent>
                    ...
                    <Editor>
                        ...
                        <UploadImage>
                            <input type="file" 
                            accept="images/gifs, images/jpeg, images/png"
                            name="image"
                            id="file"
                            style={{display: "none"}} 
                ...
                <ShareCreation>
                    ...
                    <ShareComment>
                        <AssetButton>
                            <img src="/images/share-comment.svg" />Anyone
                        </AssetButton>
                    </ShareComment>
